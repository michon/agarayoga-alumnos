class FacturaRecibo  < Prawn::Document
  ...
  def fichaCabecera()
    ...
    self.font('cocomat') do
      self.text "FACTURA", styles: [:bold], size: 42, color: 'e64b2a'
    end

    self.move_down 30 
    self.font('cocomat') do
        self.text "AGÂRA YOGA", styles: [:bold] , color: 'e64b2a', size: 16
    end

    self.move_down 6 
    self.font('Roboto') do
        self.font_size(14)
        self.text "Miguel Rodríguez López"
        self.move_down 3 
        self.text "33.322.144-C"
        self.move_down 3 
    ...
    self.font('cocomat') do
        self.font_size(16)
        self.text "FACTURAR A:", styles: [:bold] , color: 'e64b2a'
    end

    self.move_down 6 
    self.font('Roboto') do
        self.font_size(14)
        self.text @rcb.usuario.nombre
        self.move_down 3 
        self.text @rcb.usuario.dni
        self.move_down 3 
        self.text @rcb.usuario.direccion
        self.move_down 3 
        self.text @rcb.usuario.cp + ' ' + @rcb.usuario.provincia
    end
    ...
    bounding_box([cm2pt(10), cursor + cm2pt(2.2)], width: cm2pt(7), height: cm2pt(2)) do
        bounding_box([0,bounds.top], width: cm2pt(5.5), height: cm2pt(1)) do
          self.font('cocomat') do
            self.font_size(16)
            self.text "Nº DE FACTURA:", styles: [:bold] , color: 'e64b2a'
          end
        end
        ...
        bounding_box([cm2pt(5.2),bounds.top], width: cm2pt(3.5), height: cm2pt(1)) do
          self.font('Roboto') do
            self.font_size(14)
            self.text  @rcb.factura, align: :right
          end
        end
        ...
        bounding_box([0,bounds.top-cm2pt(1)], width: cm2pt(3.5), height: cm2pt(1)) do
          self.font('cocomat') do
            self.font_size(16)
            self.text "FECHA:", styles: [:bold] , color: 'e64b2a'
          end
        end
        ...
        bounding_box([cm2pt(5.2),bounds.top-cm2pt(1)], width: cm2pt(3.5), height: cm2pt(1)) do
          self.font('Roboto') do
            self.font_size(14)
            self.text  @rcb.vencimiento.strftime("%d.%m.%Y"), align: :right
          end
        end

      end
    
    self.stroke_color 'e64b2a'
    self.move_down 30
    self.stroke do
    ...
    bounding_box([0, cursor], width: cm2pt(19), height: cm2pt(0.7)) do
      bounding_box([cm2pt(0.3),bounds.top-5], width: cm2pt(13), height: cm2pt(0.7)) do
        self.font('sawasdee') do
          self.font_size(14)
          self.text "DESCRIPCIÓN", styles: [:bold] , color: 'e64b2a'
        end
      end
      bounding_box([cm2pt(14),bounds.top-5], width: cm2pt(4.8), height: cm2pt(0.7)) do
        self.font('Roboto') do
          self.font_size(14)
          self.text "IMPORTE", styles: [:bold] , align: :right, color: 'e64b2a'
        end
      end
    end
    ...
    self.move_down 7
    bounding_box([0, cursor], width: cm2pt(19), height: cm2pt(1)) do
      bounding_box([cm2pt(0.3), bounds.top], width: cm2pt(14), height: cm2pt(0.7)) do
        self.font('Roboto') do
          self.font_size(14)
          self.text @rcb.concepto
        end
      end
      bounding_box([cm2pt(14.4), bounds.top], width: cm2pt(4.3), height: cm2pt(0.7)) do
        self.font('Roboto') do
          self.font_size(14)
          self.text ActiveSupport::NumberHelper.number_to_currency(@rcb.importe/1.21, :unit => "€"), align: :right
        end
      end
    end
    ...
    bounding_box([0, cursor], width: cm2pt(19), height: cm2pt(1.3)) do
      bounding_box([cm2pt(0.3), bounds.top], width: cm2pt(14), height: cm2pt(1.2)) do
        self.font('sawasdee') do
          self.font_size(16)
          self.text "Subtotal", align: :right
        end
      end
    ...
    bounding_box([0, cursor], width: cm2pt(19), height: cm2pt(1.3)) do
      bounding_box([cm2pt(0.3), bounds.top], width: cm2pt(14), height: cm2pt(1.2)) do
        self.font('sawasdee') do
          self.font_size(16)
          self.text "I.V.A. 21%", align: :right
        end
      end
      bounding_box([cm2pt(14.4), bounds.top], width: cm2pt(4.3), height: cm2pt(1.2)) do
        self.font('sawasdee') do
          self.font_size(16)
          self.text ActiveSupport::NumberHelper.number_to_currency(@rcb.importe/1.21*0.21, :unit => "€"), align: :right
        end
      end
    end
    ...
    bounding_box([0, cursor], width: cm2pt(19), height: cm2pt(1.5)) do
      bounding_box([cm2pt(0.3), bounds.top], width: cm2pt(14), height: cm2pt(1.2)) do
        self.font('sawasdee') do
          self.font_size(22)
          self.text "Total", styles: [:bold], align: :right
        end
      end
      bounding_box([cm2pt(14.4), bounds.top], width: cm2pt(4.3), height: cm2pt(1.2)) do
        self.font('sawasdee') do
          self.font_size(22)
          self.text ActiveSupport::NumberHelper.number_to_currency(@rcb.importe, :unit => "€"), styles: [:bold], align: :right
        end
      end
    end

  frases = ["Gracias por permitirnos ser parte de tu viaje hacia el bienestar y la armonía.","Apreciamos profundamente tu energía y presencia en cada sesión.", "Namasté. Tu luz y tu práctica iluminan nuestro espacio.", "Con gratitud por compartir tu práctica de yoga con nosotros. ¡Esperamos verte pronto!", "Cada asana que realizas nos inspira. Gracias por elegirnos.", "Gracias por permitirnos ser parte de tu viaje hacia el bienestar y la armonía.", "Cada sesión es un paso más en tu camino de equilibrio y paz interior. ¡Gracias por elegirnos!", "En cada respiración y movimiento, encuentras tu centro. Agradecemos profundamente que nos hayas elegido para acompañarte.", "Tu práctica es nuestra inspiración. Gracias por compartir tu energía y tu presencia con nosotros.", "Namasté. Honramos la luz, el amor, la verdad, la belleza y la paz dentro de ti. Gracias por ser parte de nuestra comunidad.", "Que la serenidad que encuentras en tu mat se extienda a cada aspecto de tu vida. Gracias por confiar en nosotros.", "Con cada asana, tejes la tela de tu tranquilidad. Agradecidos por ser los guardianes de tu espacio sagrado.", "Tu viaje es único y estamos agradecidos de ser tus guías en este sendero de salud y plenitud.", "La gratitud es la memoria del corazón y en cada clase, dejamos una huella en el otro. Gracias por esta hermosa danza de almas.", "El centro de yoga es solo el espacio, tú eres quien lo llena de magia y propósito. Gracias por ser la esencia de nuestra existencia." ]

    bounding_box([0, 100], width: cm2pt(19), height: cm2pt(3)) do
      self.font('Handlee-Regular') do
        self.font_size(16)
        self.text frases[rand 0..18], styles: [:italic], align: :center
      end
    end
